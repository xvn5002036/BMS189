...
var status = -1;
var selectionLog = [];
var BossName = '组队任务_玩具城101层';
var 事件脚本 = ['组队任务_玩具城101层'];
var PQLog = ['组队任务_玩具城101层'];
var 开始地图 = 221023300;
var 次数限制 = [99];
var 频道 = [0];
var 破攻要求 = [0];
...
function action开始地图(e, g, h) {
    ...
    if (status <= d++) {
        ...
        if (status === d++) {
            var l = '#e<' + BossName + '>#n\r\n\r\n';
            l += '从这里往上到处都是很危险的东西，你不能继续往上走了。你想和队员们一起齐心协力，完成任务吗？如果想挑战的话，就通过#b所属组队的队长#k来和我说话。\r\n#b';
            l += '#L0#我想参加组队任务。#l\r\n';
            l += '#L10#我想寻找组队。#l\r\n';
            l += '#L11#我想听听说明。#l\r\n';
            l += '#L12#我想领取#t1022073#。#l\r\n';
            l += '#L13#我想知道今天的剩余挑战次数。#l';
            cm.askMenu(l);
        } else {
            if (status === d++) {
                switch (h) {
                case 10:
                    ...
                    break;
                case 11:
                    cm.sendNormalTalk('#e<组队任务：时空裂缝>#n\r\n#b#m220000000##k出现了时空裂缝！如果想要阻止入侵这里的怪物，我们需要勇敢的冒险家的自发帮助。请和同伴们齐心协力，拯救#m220000000#吧！\n必须突破消灭怪物或解开谜题的各种难关，打败#r#o9300012##k。\r\n  - #e等级#n ：120级以上 #r( 推荐等级：120 ~ 139 )#k \r\n  - #e限制时间#n ： 20分钟\r\n  - #e参加人员#n ： 3~6名\r\n  - #e获得道具#n ：#i1022073:# #t1022073# #b(每帮忙5次时获得)#k\r\n                         各种消耗、其他、装备道具', 0, 2040034, false, false);
                    status = -1;
                    break;
                case 12:
                    cm.sendNormalTalk('你每帮助我5次，我就会给你1个#i1022073:##b#t1022073##k。你只要再帮我#b5次#k，就可以获得#b#t1022073##k了。', 0, 2040034, false, true);
                    status = -1;
                    break;
                case 13:
                                            ...
                                            if (cm.getPartyMembers().size() < 最小人数[chs] || cm.getPartyMembers().size() > 最大人数[chs]) {
                                                ...
                                                if (c == 0) {
                                                    ...
                                                    f.getPlayers().forEach(function (i) {
                                                        ...
                                                        i.getAPI().removeAll(4001022);
                                                        i.getAPI().removeAll(4001023);
                                                    });
...
function action其他地图(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            cm.sendNormalTalk('如果你要挑战一下，我就会指引你到达塔的顶端……', 0, 2040034, false, true);
        } else {
            if (status === a++) {
