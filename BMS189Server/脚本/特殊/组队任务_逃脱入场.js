...
function action开始地图(e, g, h) {
    ...
    if (status <= d++) {
        ...
        if (status === d++) {
            var l = '#e<' + BossName + '>#n\r\n\r\n';
            l += '虽说想就这样立刻逃跑，但是……我无法拒绝他的嘱托。在这座城里，被关在空中监狱的人们正在寻找帮他们逃离监狱的人。 \r\n#b';
            l += '#L0#我要去帮助被关在城堡里的冒险家！#l\r\n';
            l += '#L11#请告诉我一些关于城堡监狱的信息。#l\r\n';
            l += '#L13#告诉我一些关于#t4001534#的信息。#l\r\n';
            ...
            if (status === d++) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    cm.sendNormalTalk('在这座城内有个隐藏的塔。塔内的空中监狱里，囚禁着很多人。必须救出他们才行…… \r\n - #e等级#n ： 140级以上#r(推荐等级：140 ~ 159 )#k \r\n - #e限制时间#n ： 20分钟\r\n - #e参加人员#n ： 3~6名\r\n - #e获得道具#n：\r\n#i1132094:# #t1132094#\r\n#i1132095:# #t1132095#\r\n#i1132096:# #t1132096#\r\n#i1132097:# #t1132097#\r\n#i1132098:# #t1132098#\r\n\r\n如果你进入监狱的话，你必须得记住以下几点。\r\n1。得躲开障碍物，逃出那座塔。\r\n2。得消灭地图里所有的警卫。\r\n3。得逃出为了防止别人接近而设置的迷宫。\r\n4。得消灭所有守门的警卫。\r\n5。得通过通往空中监狱的最后障碍物。\r\n6。得消灭警卫，找到钥匙，打开监狱门。\r\n7。得找到教导官阿尼，让被囚禁的人们重新获得自由。', 0, 9020005, false, true);
                    status = -1;
                    break;
                case 12:
                    ...
                    break;
                case 13:
                    cm.sendNormalTalk('#r#t4001534##k就在隐藏的塔中的看守身上。搜集#b5个#k交给我，我会送你一份小礼物。搜集5个钥匙，意味着你为囚禁在城里的人们提供了帮助。\r\n#i1132094:# #b#t1132094#，\r\n#i1132095:# #b#t1132095#，\r\n#i1132096:# #b#t1132096#，\r\n#i1132097:# #b#t1132097#，\r\n#i1132098:# #b#t1132098##k', 0, 9020005, false, true);
                    status = -1;
                    break;
                case 9:
                case 8:
...
function action其他地图(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            cm.sendNormalTalk('你比看上去要勇敢啊。我会告诉你去空中监狱的路，跟我来吧。', 0, 9020005, false, true);
        } else {
            if (status === a++) {
