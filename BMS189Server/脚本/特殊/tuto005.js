...
function action(c, b, a) {
    ...
    c == 1 ? chat++ : chat--;
    if (chat == 0) {
        cm.sendNextS('Who are you? Are you lost?');
    } else {
        if (chat == 1) {
            ...
            if (chat == 2) {
                cm.sendNextPrevS('What are you talking about?');
            } else {
                if (chat == 3) {
                    cm.sendNextPrevS('Mind your manners, peon！This is the Empress!', 1, 0, 1106000);
                } else {
                    if (chat == 4) {
                        cm.sendNextPrevS('You\'re the guy from before！What\'s going on here? That guy you talked about, Chromile... I found a letter from him in the attic. Is that Limbert\'s real name or something?');
                    } else {
                        if (chat == 5) {
                            ...
                            if (chat == 6) {
                                ...
                                if (chat == 7) {
                                    cm.sendNextPrevS('My father left me here when I was little. He abandoned me to this old chicken-keeper.');
                                } else {
                                    if (chat == 8) {
                                        ...
                                        if (chat == 9) {
                                            cm.sendNextPrevS('Save me? He didn\'t save me. He left me to be a slave in this shack. He didn\'t even give me a name！And now I find out I\'ve been here waiting for a father that\'ll never return...');
                                        } else {
                                            if (chat == 10) {
