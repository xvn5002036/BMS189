...
function action开始地图(e, g, h) {
    ...
    if (status <= d++) {
        ...
        if (status === d++) {
            var l = '#e<' + BossName + '>#n\r\n\r\n';
            l += '不好了！！坎特好像陷入危险了。他说要亲自去调查海洋生物的异常行动，可是出去后就没回来，肯定是出事了。我得把坎特找回来。请你帮帮忙！\r\n#b';
            l += '#L0#我去找坎特。#l\r\n';
            l += '#L10#寻找同行的组队。#l\r\n';
            l += '#L11#请详细地说说是怎么回事吧。#l\r\n';
            l += '#L13#我想要#t1022175#。#l\r\n';
            ...
            if (status === d++) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    cm.sendNormalTalk('坎特在研究冒险家搜集到的样品时遇到了一些困难，他决定亲自调查海洋生物的异常行为，并前往了危险的大海。自从他去了大海之后，再也没有回来，音讯全无。他肯定是发生了什么事情。\r\n - #e等级#n：160级以上#r(推荐等级：160 ~ 179 )#k \r\n - #e限制时间#n：20分钟\r\n - #e参加人员#n：2~6名\r\n - #e获得道具#n ：\r\n#i1022175:# #t1022175#', 0, 9020003, false, true);
                    status = -1;
                    break;
                case 12:
                ...
                case 13:
                    ...
                    cm.playerMessage(-1, '获得了1个坎特的新潜水镜道具。（装备）');
...
function action其他地图(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            cm.sendNormalTalk('谢谢！请和我一起去危海岔路吧。', 0, 9020003, false, true);
        } else {
            if (status === a++) {
