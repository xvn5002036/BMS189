...
var header = '#fEffect/BasicEff.img/MainNotice/AbyssExpedition/Notify/11##r[V169] #b深渊远征队';
var quests = [500763];
var events = [500927];
var alwaysShow = [];
function start() {
    for (var a = 500841; a <= 500842; a++) {
        quests.push(a);
    }
    for (var a = 64692; a <= 64698; a++) {
        quests.push(a);
    }
    for (var a = 64901; a <= 64908; a++) {
        quests.push(a);
    }
    action(1, 0, 0);
}
