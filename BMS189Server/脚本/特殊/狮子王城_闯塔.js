...
function action(c, b, a) {
    if (cm.getQuestStatus(3139) == 0) {
        ...
        if (cm.isQuestActive(3139)) {
            action2(c, b, a);
        } else {
            if (cm.getQuestStatus(3139) == 2 && cm.getQuestStatus(3140) == 0) {
                action3(c, b, a);
            } else {
                if (cm.isQuestActive(3140)) {
                    action4(c, b, a);
                } else {
                    if (cm.getQuestStatus(3140) == 2 && cm.getQuestStatus(3141) == 0) {
                        action5(c, b, a);
                    } else {
                        if (cm.isQuestActive(3141) && cm.isQuestActive(3167)) {
                            action6(c, b, a);
                        } else {
                            if (cm.isQuestActive(3141)) {
                                action7(c, b, a);
                            } else {
                                cm.dispose();
                            }
