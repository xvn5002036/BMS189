...
function start() {
    if (cm.getMapId() == startmap) {
        ...
        cm.askMenuS_Bottom('#e<首领怪：' + BossName + '>#n\r\n为了与黑魔法师对峙，要前往#b黑暗神殿#k吗？\r\n#r（如果出现黑屏，请在1366x768分辨率下进行）#k#b ' + b);
    } else {
        cm.askYesNoS_Bottom('#e<首领怪：' + BossName + '>#n\r\n\r\n确定要放弃任务，离开这里吗？\r\n');
    }
}
function action(h, j, l) {
    ...
    if (cm.getMapId() == startmap) {
        if (status == 0) {
            ...
            cm.askYesNoS_Bottom(o + '           #b#h0# #k#e是否现在就进入？#n');
        } else {
            if (status == 1) {
                                    ...
                                    if (!cm.allMembersHere()) {
                                        ...
                                        if (g) {
                                            ...
                                            if (b == null || open == false) {
                                                ...
                                                if (b.getNumberProperty('state') == 0) {
                                                    cm.dispose();
