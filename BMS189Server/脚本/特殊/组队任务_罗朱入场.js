                                            ...
                                            if (cm.getPartyMembers().size() < 最小人数[chs] || cm.getPartyMembers().size() > 最大人数[chs]) {
                                                ...
                                                if (c == 0) {
                                                    ...
                                                    f.getPlayers().forEach(function (i) {
                                                        ...
                                                        i.getAPI().removeAll(4001130);
                                                        i.getAPI().removeAll(4001131);
                                                        i.getAPI().removeAll(4001132);
                                                        i.getAPI().removeAll(4001133);
                                                        i.getAPI().removeAll(4001134);
                                                        i.getAPI().removeAll(4001135);
                                                    });
