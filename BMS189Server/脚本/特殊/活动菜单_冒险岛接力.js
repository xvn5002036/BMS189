...
var icon169 = '#fEffect/BasicEff.img/MainNotice/MapleRelay/Notify/11#';
var header = '#fEffect/BasicEff.img/MainNotice/MapleRelay/Notify/11##r#b冒险岛接力';
var quests = [500907];
var events = [500906];
var alwaysShow = [];
function start() {
    for (var a = 64761; a <= 64787; a++) {
        quests.push(a);
    }
    action(1, 0, 0);
}
