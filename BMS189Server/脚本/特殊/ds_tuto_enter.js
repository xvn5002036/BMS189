        ...
        if (status == 1) {
            ...
            if (status == 2) {
                ...
                if (status == 3) {
                    ...
                    if (status == 4) {
                        cm.inGameDirectionEvent_头顶图片(['Effect/Direction6.img/effect/tuto/balloonMsg1/14'], [
                            2000,
                            0,
                            -100
                        ]);
                        cm.inGameDirectionEvent_OneTimeAction('恶魔新手剧情_蓄力突刺', 0);
                        cm.fieldEffect_PlayFieldSound('demonSlayer/31111003');
                        cm.inGameDirectionEvent_头顶图片(['Skill/3111.img/skill/31111003/effect'], [
                            0,
                            0,
                            0
                        ]);
                        ...
                        if (status == 5) {
                            ...
                            if (status == 6) {
                                ...
                                if (status == 7) {
                                    ...
                                    if (status == 8) {
                                        cm.inGameDirectionEvent_头顶图片(['Effect/Direction6.img/effect/tuto/balloonMsg1/15'], [
                                            2000,
                                            0,
                                            -100
                                        ]);
                                        cm.inGameDirectionEvent_MoveAction(1);
                                        cm.inGameDirectionEvent_OneTimeAction('恶魔新手剧情_冲刺', 0);
                                        cm.fieldEffect_PlayFieldSound('demonSlayer/31121001');
                                        cm.inGameDirectionEvent_头顶图片(['Skill/3112.img/skill/31121001/effect'], [
                                            0,
                                            0,
                                            0,
                                            0,
