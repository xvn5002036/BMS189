...
function action(d, b, a) {
    ...
    if (status == 0) {
        var c = '';
        c += '#b#L1#获得装备制作名匠效果(需要10000点卷)#l#k\r\n';
        c += '#r#L2#获得饰品制作名匠效果(需要10000点卷)#l#k\r\n';
        c += '#r#L3#获得炼金术名匠效果(需要10000点卷)#l#k';
        cm.askMenu(c);
    } else {
        if (status == 1) {
            switch (a) {
            case 1:
                if (cm.getPlayer().getCSPoints(1) < 10000) {
                    ...
                    cm.teachSkill(92020000, 536870912, 20);
            ...
            case 2:
                if (cm.getPlayer().getCSPoints(1) < 10000) {
                    ...
                    cm.teachSkill(92030000, 536870912, 20);
                    cm.teachSkill(92040000, 0, 20);
                    cm.playerMessage(1, '装备制作名匠效果已升级完成.\n名匠效果开关控制的,好多人找不到,按B键就能看到,找仔细点');
                }
                break;
            case 3:
                if (cm.getPlayer().getCSPoints(1) < 10000) {
                    ...
                    cm.teachSkill(92020000, 0, 20);
                    cm.teachSkill(92030000, 0, 20);
                    cm.teachSkill(92040000, 536870912, 20);
                    cm.playerMessage(1, '装备制作名匠效果已升级完成.\n名匠效果开关控制的,好多人找不到,按B键就能看到,找仔细点');
                }
                break;
            }
