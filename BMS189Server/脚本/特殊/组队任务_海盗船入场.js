        ...
        if (status === d++) {
            ...
            if (status === d++) {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    cm.sendNext('正好我这有多余的，送你一顶吧。');
                    cm.playerMessage(-1, '获得了1个帅气海盗帽道具。（装备）');
...
function action其他地图(d, c, b) {
    ...
    if (status <= a++) {
        ...
        if (status === a++) {
            cm.askMenu('#o9300119##k发动了袭击。桔梗之王#b#p2094001##k大人被绑架了。请消灭 #o9300119#，救出#b#p2094001##k大人。拜托了。\r\n#b#L0#听听久翁的委托。#l');
        } else {
            if (status === a++) {
