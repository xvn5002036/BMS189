...
function action(c, b, a) {
    ...
    c == 1 ? chat++ : chat--;
    if (chat == 0) {
        cm.sendNext('Lotus? Lotus！Are you awake?!', 1, 9075005);
    } else {
        if (chat == 1) {
                            ...
                            if (chat == 6) {
                                ...
                                if (chat == 7) {
                                    ...
                                    if (chat == 8) {
                                        ...
                                        if (chat == 9) {
                                            cm.sendNextPrevS('I assure you, Commander Orchid. Lotus is perfectly fine. Do you wish to see? Here... Execute Program Alpha-97.');
                                        } else {
                                            if (chat == 10) {
