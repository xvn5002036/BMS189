...
function action开始地图(e, g, h) {
    ...
    if (status <= d++) {
        ...
        if (status === d++) {
            var l = '#e<' + BossName + '>#n\r\n\r\n';
            l += '你好, 我是达尔利! 你去过迎月花山丘吗? 那里可是个美丽的地方. 直到怪物进来....? \r\n#b';
            l += '#L0#我想参加组队任务。#l\r\n';
            l += '#L10#我想寻找组队。#l\r\n';
            l += '#L11#我想听听说明。#l\r\n';
            l += '#L13#我要兑换年糕帽子。\r\n#l';
            ...
            if (status === d++) {
                ...
                case 10:
                    ...
                    break;
                case 11:
                    cm.sendNext('#e <组队任务: 月妙的年糕>#n \r\n\r\n一个神秘的 #r月亮兔子#k 只出现在 #b#m910010000##k 满月时分.\r\n如果你想认识月亮兔子的话，请在指定的地点种植樱草种子然后等到满月；请务必保护月亮兔子直到获得#r 10个年糕 #k为止。\r\n\r\n #e - Level:#n 10或以上 #r (推荐级别：' + 最低等级 + ' - ' + 最高等级 + ')#k \r\n #e - 时间限制:#n 10 min \r\n #e - 参加人数:#n ' + 最小人数 + ' - ' + 最大人数 + ' \r\n #e - 奖励:#n #v1003266# #b#z1003266# \r\n #e#k - 其他:#n #b#v1002798# #z1002798##k');
                    status = -1;
                    break;
                case 12:
                ...
                case 13:
                    if (!cm.canHold(1003266, 1)) {
                        ...
                        if (cm.haveItem(4001101, 10)) {
                            ...
                            cm.sendOk('为了兑换#b#v1003266##z1003266##k，你需要带来10个#r#v4001101##z4001101##k。');
                            cm.dispose();
                        }
                    }
                    break;
                                        ...
                                        if (!cm.allMembersHere()) {
                                            ...
                                            if (cm.getPartyMembers().size() < 最小人数[chs] || cm.getPartyMembers().size() > 最大人数[chs]) {
                                                ...
                                                if (c == 0) {
                                                    ...
                                                    f.getPlayers().forEach(function (n) {
                                                        if (cm.getPlayer().isGM()) {
                                                            n.getAPI().addPopupSay(0, 3000, '怪物动态等级' + k + '级。');
                                                        }
                                                        for (var m = 4001044; m < 4001064; m++) {
                                                            n.getAPI().removeAll(m);
                                                        }
                                                    });
